...
function genList(list) {
    ...
    $.each(list, function(idx, ktv) {
        html += "<li><a href='http://wechat.fusionmaster.net/dist/#!/ktv/" + ktv.id + "' data-idx='" + idx + "' data-id='" + ktv.id + "'><div class='inner'>"
...
function goPage(pid) {
    ...
    case "offline31":
    case "offline32":
        if (ktvdata) $(".btn-ktv").html("预订" + ktvdata.name.replace(/(\(|（)/, "<br>$1")).attr("href", "http://wechat.fusionmaster.net/dist/#!/ktv/" + ktvdata.ktvid);
        break;
    default:
        break;
    }
...
// http://wechat.fusionmaster.net/wechat_ktv/Home/Event/enter/ktvid/XKTV00001
