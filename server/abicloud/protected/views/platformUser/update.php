...
$this->menu=array(
	...
	array('label'=>'View PlatformUser', 'url'=>array('view', 'id'=>$model->id)),
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-folder-open"></i> <?php echo Yii::t('PlatformUser', 'Update PlatformUser') ?> ( <?php echo $model->id; ?> )
            </h2>
            <div class="box-icon">
