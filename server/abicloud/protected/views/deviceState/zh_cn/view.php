...
$this->breadcrumbs=array(
	Yii::t('site', 'Device States')=>array('index'),
	$model->id,
);
$this->pageTitle = Yii::t('site', Yii::app()->name) . ' - ' . Yii::t('site', 'Device States')  . ' - ' . $model->id;
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-film"></i> <?php echo Yii::t('DeviceState', 'DeviceState') ?> ( <?php echo $model->id; ?> )
            </h2>
            <div class="box-icon">
...
<div class="modal hide fade" id="myConfirmModal">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('DeviceState', 'Are you sure to delete devicestate {name}?', array('{name}' => $model->id)) ?></p>
    </div>
