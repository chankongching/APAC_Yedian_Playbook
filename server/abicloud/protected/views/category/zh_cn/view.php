...
$this->pageTitle = Yii::t('site', Yii::app()->name) . ' - ' . Yii::t('site', 'Categories')  . ' - ' . $model->name;
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-film"></i> <?php echo Yii::t('Category', 'Category') ?> ( <?php echo $model->name; ?> )
            </h2>
            <div class="box-icon">
...
<div class="modal hide fade" id="myConfirmModal">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('Category', 'Are you sure to delete category {name}?', array('{name}' => $model->name)) ?></p>
    </div>
