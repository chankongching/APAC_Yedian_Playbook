...
$this->breadcrumbs=array(
	Yii::t('site', 'Checkin Codes')=>array('index'),
	$model->name,
);
$this->pageTitle = Yii::t('site', Yii::app()->name) . ' - ' . Yii::t('site', 'Checkin Codes')  . ' - ' . $model->name;

$this->menu=array(
	array('label'=>'List CheckinCode', 'url'=>array('index')),
	array('label'=>'Create CheckinCode', 'url'=>array('create')),
	array('label'=>'Update CheckinCode', 'url'=>array('update', 'id'=>$model->id)),
	array('label'=>'Delete CheckinCode', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-film"></i> <?php echo Yii::t('CheckinCode', 'CheckinCode') ?> ( <?php echo $model->name; ?> )
            </h2>
            <div class="box-icon">
...
<div class="modal hide fade" id="myConfirmModal">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('CheckinCode', 'Are you sure to delete checkincode {name}?', array('{name}' => $model->name)) ?></p>
    </div>
