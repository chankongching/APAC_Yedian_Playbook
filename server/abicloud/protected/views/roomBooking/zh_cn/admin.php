...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            ...
            <!-- div style="float:right;"><a href="#" class="btn search-button"><?php echo Yii::t('RoomBooking', 'Advanced Search') ?></a></div -->
        </div>
    ...
    <div class="modal-footer">
        ...
        <a href="#" class="btn btn-primary" data-dismiss="modal"><?php echo Yii::t('site', 'Cancel') ?></a>
            ...
            <?php
                    $_buttons = array();
                    $_template = '';
                    if( Yii::app()->user->checkAccess('RoomBooking.*') || Yii::app()->user->checkAccess('RoomBooking.View') ) { 
                        $_buttons['view'] = array(
                                'label' => '',
                    ...
                    if( Yii::app()->user->checkAccess('RoomBooking.*') || Yii::app()->user->checkAccess('RoomBooking.Update') ) { 
                    ...
                    if( Yii::app()->user->checkAccess('RoomBooking.*') || Yii::app()->user->checkAccess('RoomBooking.Delete') ) { 
...
<script type="text/javascript">
    ...
    jQuery(function($) {
        ...
        jQuery('#mySearchFormModal form').submit(function(){
            jQuery('#roombooking-grid').yiiGridView('update', {
                data: $(this).serialize()
            });
            return false;
        });
