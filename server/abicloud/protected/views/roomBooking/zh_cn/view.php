...
$this->breadcrumbs=array(
	Yii::t('site', 'Room Bookings')=>array('index'),
	$model->id,
);
...
$this->menu=array(
	...
	array('label'=>'Update RoomBooking', 'url'=>array('update', 'id'=>$model->id)),
	array('label'=>'Delete RoomBooking', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-film"></i> <?php echo Yii::t('RoomBooking', 'RoomBooking') ?> ( <?php echo $model->id; ?> )
            </h2>
            <div class="box-icon">
...
<div class="modal hide fade" id="myConfirmModal">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('RoomBooking', 'Are you sure to delete roombooking {name}?', array('{name}' => $model->id)) ?></p>
    </div>
