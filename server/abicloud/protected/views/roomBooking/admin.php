...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-picture"></i> <?php echo Yii::t('site', 'Room Bookings') ?> ( <?php echo $total; ?> <?php echo ($total > 1) ? Yii::t('site', 'room bookings') : Yii::t('RoomBooking', 'roombooking'); ?> )</h2>
            <div class="box-icon">
            ...
            <div class="btn-toolbar" style="margin-bottom: 15px;margin-top: 0px;border-bottom: 1px solid #EEEEEE;">
                <div class="btn-group">
                    <a class="btn btn-success btn-round btn-add-file" href="<?php echo $this->createUrl('create'); ?>">
                        ...
                        <?php echo Yii::t('RoomBooking', 'Add RoomBooking') ?>                                            
                    </a>
                </div>
            </div><!-- Toolbar -->
