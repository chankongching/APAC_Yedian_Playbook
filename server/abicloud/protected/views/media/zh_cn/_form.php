...
<fieldset>
    ...
    <?php if ($model->isNewRecord) { ?>
    <div class="control-group">
        <?php echo $form->labelEx($model,'bpic_file', array('class' => 'control-label', 'label' => Yii::t('Media','Upload Bpic Url'))); ?>
        <div class="controls">
                <input class="input-file uniform_on" id="ytFiles_bpic_file" name="Media[bpic_file]" type="file">
    ...
    <div class="control-group">
        <?php echo $form->labelEx($model,'spic_file', array('class' => 'control-label', 'label' => Yii::t('Media','Upload Spic Url'))); ?>
        <div class="controls">
                <input class="input-file uniform_on" id="ytFiles_spic_file" name="Media[spic_file]" type="file">
	...
	<?php echo $form->labelEx($model,'bpic_filename', array('class' => 'control-label')); ?>
		...
		<?php 
                ...
                echo ( CHtml::image($model->getMediaPicUrl($model,$model->bpic_url,1), Yii::t("files", "View big picture"), array("style" => "height:50px;")));
                ?>
	...
	<?php echo $form->labelEx($model,'spic_filename', array('class' => 'control-label')); ?>
		...
		<?php 
                ...
                echo ( CHtml::image($model->getMediaPicUrl($model,$model->spic_url,0), Yii::t("files", "View small picture"), array("style" => "height:50px;")));
                ?>
