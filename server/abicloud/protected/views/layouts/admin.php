...
$files_total = array_sum(array_column($categories, 'files'));
?>
<!DOCTYPE html>
<html lang="en">
    <head>
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        ...
                        <a class="brand" href="<?php echo Yii::app()->homeUrl; ?>"> <img alt="Charisma Logo" src="<?php echo Yii::app()->theme->baseUrl; ?>/img/logo20.png" /> <span><?php echo Yii::app()->name; ?></span></a>
                        ...
                        <div class="btn-group pull-right" >
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo $this->createUrl('user/view', array('id' => Yii::app()->user->id)); ?>">Profile</a></li>
                                <li class="divider"></li>
                    ...
                    <div class="span2 main-menu-span">
                        <div class="well nav-collapse sidebar-nav">
                            <ul class="nav nav-tabs nav-stacked main-menu">
                                ...
                                <li><a class="ajax-link" href="<?php echo Yii::app()->homeUrl; ?>" title="Home"><i class="icon-home"></i><span class="hidden-tablet"> Home</span></a></li>
                                <li><a class="ajax-link" href="<?php echo $this->createUrl('category/index'); ?>" title="Categories"><i class="icon-folder-open"></i><span class="hidden-tablet"> Categories</span>
            <?php echo '<span class="mynotification green hidden-tablet" style="">' . count($categories) . '</span>'; ?>
                                    </a></li>
                                <li><a class="ajax-link" href="<?php echo $this->createUrl('files/index'); ?>" title="Files"><i class="icon-picture"></i><span class="hidden-tablet"> Files</span>
                    <?php echo '<span class="mynotification yellow hidden-tablet" style="">' . $files_total . '</span>'; ?>
                                    </a></li>
                                <li class="nav-header hidden-tablet">Category</li>
    <?php
    if (!empty($categories)) {
        foreach ($categories as $key => $category) {
            echo '<li><a class="ajax-link" href="' . $this->createUrl('category/view', array('id' => $category['id'])) . '" title="' . $category['name'] . '"><i class="icon-eye-open"></i><span class="hidden-tablet"> ' . $category['name'] . '</span>';
            echo '<span class="mynotification yellow hidden-tablet" style="">' . $category['files'] . '</span>';
            echo '</a></li>';
        }
    }
    ?>
                                ...
                                <li><a class="ajax-link" href="<?php echo $this->createUrl('user/index'); ?>" title="Users"><i class="icon-user"></i><span class="hidden-tablet"> Users</span></a></li>
                                <li><a href="<?php echo $this->createUrl('setting/index'); ?>" title="API Setting"><i class="icon-globe"></i><span class="hidden-tablet"> API Setting</span></a></li>
                            </ul>
                        </div><!--/.well -->
                    </div><!--/span-->
                    <!-- left menu ends -->
