                    ...
                    <div class="span2 main-menu-span">
                        <div class="well nav-collapse sidebar-nav">
                            <ul class="nav nav-tabs nav-stacked main-menu">
                                ...
                                <li><a class="ajax-link" href="<?php echo $this->createUrl('media/index'); ?>" title="<?php echo Yii::t('site', 'Medias') ?>"><i class="icon-user"></i><span class="hidden-tablet"> <?php echo Yii::t('site', 'Medias') ?></span>
