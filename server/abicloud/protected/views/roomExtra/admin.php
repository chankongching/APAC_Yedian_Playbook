...
$this->breadcrumbs=array(
	Yii::t('site', 'Room Extras'),
);
$this->pageTitle = Yii::t('site', Yii::app()->name) . ' - ' . Yii::t('site', 'Room Extras');
$total = $model->count();

$this->menu=array(
	array('label'=>'List RoomExtra', 'url'=>array('index')),
	array('label'=>'Create RoomExtra', 'url'=>array('create')),
);
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-picture"></i> <?php echo Yii::t('site', 'Room Extras') ?> ( <?php echo $total; ?> <?php if($total > 1) echo Yii::t('site', 'room extras'); else echo Yii::t('RoomExtra', 'roomextra'); ?> )</h2>
            <div class="box-icon">
                <a href="#" class="btn btn-setting btn-round"><i class="icon-cog"></i></a>
                <a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
                <!-- a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a -->
            </div>
            <div style="float:right;"><a href="#" class="btn search-button"><?php echo Yii::t('RoomExtra', 'Advanced Search') ?></a></div>
        </div>
            ...
            <div class="btn-toolbar" style="margin-bottom: 15px;margin-top: 0px;border-bottom: 1px solid #EEEEEE;">
                <div class="btn-group">
                    <a class="btn btn-success btn-round btn-add-file" href="<?php echo $this->createUrl('create'); ?>">
                        ...
                        <?php echo Yii::t('RoomExtra', 'Add RoomExtra') ?>                                            
                    </a>
                </div>
            </div><!-- Toolbar -->
	...
	//'update_user_id',
                    ...
                    array(
                        ...
                        'buttons' => array(
                            ...
                            'view' => array(
                                'label' => '',
                                'options' => array('class' => 'icon icon-color icon-search view', 'title' => Yii::t('RoomExtra', 'View this roomextra'))
                            ),
                            'update' => array(
                                'label' => '',
                                'options' => array('class' => 'icon icon-color icon-edit update', 'title' => Yii::t('RoomExtra', 'Update this roomextra'))
                            ),
                            'delete' => array(
                                'label' => '',
                                'options' => array('class' => 'icon icon-color icon-close delete', 'title' => Yii::t('RoomExtra', 'Delete this roomextra'))
                            ),
                        ),
...
<div class="modal hide fade" id="myConfirmAllModal" dialogtype="confirm">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('RoomExtra', 'Are you sure to delete all room extras?') ?></p>
    </div>
    <div class="modal-footer">
...
<div class="modal hide fade" id="myConfirmModal" dialogtype="confirm">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('RoomExtra', 'Are you sure to delete this roomextra?') ?></p>
    </div>
    <div class="modal-footer">
...
<script type="text/javascript">
    ...
    jQuery(function($) {
        ...
        jQuery('#mySearchFormModal form').submit(function(){
            jQuery('#roomextra-grid').yiiGridView('update', {
                data: $(this).serialize()
            });
            return false;
        });
        ...
        jQuery('.btn-delete-allfile').click(function(e) {
            ...
            jQuery('#myConfirmAllModal div.modal-header h3').html('<?php echo Yii::t("RoomExtra", "Delete All room extras Confirm Window") ?>');
            jQuery('#myConfirmAllModal div.modal-body p').html('<?php echo Yii::t("RoomExtra", "Are you sure to delete all room extras?") ?>');
        ...
        jQuery('.button-column a.delete').click(function(e) {
            ...
            jQuery('#myConfirmModal div.modal-header h3').html('<?php echo Yii::t("RoomExtra", "Delete roomextra Confirm Window") ?>');
            jQuery('#myConfirmModal div.modal-body p').html('<?php echo Yii::t("RoomExtra", "Are you sure to delete roomextra") ?>' + ' ' + name + '?');
