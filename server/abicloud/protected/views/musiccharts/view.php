...
$this->breadcrumbs=array(
	Yii::t('Musiccharts', 'Musiccharts')=>array('index'),
	$model->name,
);
$this->pageTitle = Yii::t('site', Yii::app()->name) . ' - ' . Yii::t('Musiccharts', 'Musiccharts')  . ' - ' . $model->name;

$this->menu=array(
	array('label'=>'List Musiccharts', 'url'=>array('index')),
	array('label'=>'Create Musiccharts', 'url'=>array('create')),
	array('label'=>'Update Musiccharts', 'url'=>array('update', 'id'=>$model->id)),
	array('label'=>'Delete Musiccharts', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-film"></i> <?php echo Yii::t('Musiccharts', 'Musiccharts') ?> ( <?php echo $model->name; ?> )
            </h2>
            <div class="box-icon">
	...
	//'bpic_filename',
	//'bpic_url',
        array('name' => 'bpic_url', 'type' => 'raw', 'value' => (empty($model->bpic_url) ? "" : CHtml::image($model->attach_url . "/" . $model->bpic_url, Yii::t("files", "View big picture"), array("style" => "height:50px;")))),
	//'spic_filename',
	//'spic_url',
        array('name' => 'spic_url', 'type' => 'raw', 'value' => (empty($model->spic_url) ? "" : CHtml::image($model->attach_url . "/" . $model->spic_url, Yii::t("files", "View big picture"), array("style" => "height:50px;")))),
	'status',
	'create_time',
	'create_user_id',
	'update_time',
...
<div class="modal hide fade" id="myConfirmModal">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('Musiccharts', 'Are you sure to delete musiccharts {name}?', array('{name}' => $model->name)) ?></p>
    </div>
