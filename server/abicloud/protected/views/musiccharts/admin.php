...
$this->breadcrumbs=array(
	Yii::t('Musiccharts', 'Musiccharts'),
);
$this->pageTitle = Yii::t('site', Yii::app()->name) . ' - ' . Yii::t('Musiccharts', 'Musiccharts');
$total = $model->count();

$this->menu=array(
	array('label'=>'List Musiccharts', 'url'=>array('index')),
	array('label'=>'Create Musiccharts', 'url'=>array('create')),
);
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-picture"></i> <?php echo Yii::t('Musiccharts', 'Musiccharts') ?> ( <?php echo $total; ?> <?php echo ($total > 1) ? Yii::t('Musiccharts', 'musiccharts') : Yii::t('Musiccharts', 'musiccharts'); ?> )</h2>
            <div class="box-icon">
                <!-- a href="#" class="btn btn-setting btn-round"><i class="icon-cog"></i></a -->
                <a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
                <!-- a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a -->
            </div>
            <!-- div style="float:right;"><a href="#" class="btn search-button"><?php echo Yii::t('Musiccharts', 'Advanced Search') ?></a></div -->
        </div>
            ...
            <div class="btn-toolbar" style="margin-bottom: 15px;margin-top: 0px;border-bottom: 1px solid #EEEEEE;">
                <div class="btn-group">
                    <a class="btn btn-success btn-round btn-add-file" href="<?php echo $this->createUrl('create'); ?>">
                        ...
                        <?php echo Yii::t('Musiccharts', 'Add Musiccharts') ?>                                            
                    </a>
                </div>
                <!-- div class="btn-group">
                    <a class="btn btn-success btn-round btn-add-file" href="<?php echo $this->createUrl('import'); ?>">
                        ...
                        <?php echo Yii::t('Musiccharts', 'Import Musiccharts') ?>                                            
                    </a>
                </div -->
                <div class="btn-group">
                    <?php $this->renderExportGridButton('musiccharts-grid', '导出热歌榜名', 'btn-export-csv-file', array('class' => 'btn btn-info btn-round')); ?>
                </div>
            </div><!-- Toolbar -->
	...
	//'update_user_id',
                    ...
                    array(
                        ...
                        'buttons' => array(
                            ...
                            'view' => array(
                                'label' => '',
                                'options' => array('class' => 'icon icon-color icon-search view', 'title' => Yii::t('Musiccharts', 'View this musiccharts'))
                            ),
                            'update' => array(
                                'label' => '',
                                'options' => array('class' => 'icon icon-color icon-edit update', 'title' => Yii::t('Musiccharts', 'Update this musiccharts'))
                            ),
                            'delete' => array(
                                'label' => '',
                                'options' => array('class' => 'icon icon-color icon-close delete', 'title' => Yii::t('Musiccharts', 'Delete this musiccharts'))
                            ),
                        ),
...
<div class="modal hide fade" id="myConfirmAllModal" dialogtype="confirm">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('Musiccharts', 'Are you sure to delete all musiccharts?') ?></p>
    </div>
    <div class="modal-footer">
...
<div class="modal hide fade" id="myConfirmModal" dialogtype="confirm">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('Musiccharts', 'Are you sure to delete this musiccharts?') ?></p>
    </div>
    <div class="modal-footer">
...
<script type="text/javascript">
    ...
    jQuery(function($) {
        ...
        jQuery('#mySearchFormModal form').submit(function(){
            jQuery('#musiccharts-grid').yiiGridView('update', {
                data: $(this).serialize()
            });
            return false;
        });
        ...
        jQuery('.btn-delete-allfile').click(function(e) {
            ...
            jQuery('#myConfirmAllModal div.modal-header h3').html('<?php echo Yii::t("Musiccharts", "Delete All musiccharts Confirm Window") ?>');
            jQuery('#myConfirmAllModal div.modal-body p').html('<?php echo Yii::t("Musiccharts", "Are you sure to delete all musiccharts?") ?>');
        ...
        jQuery('.button-column a.delete').click(function(e) {
            ...
            jQuery('#myConfirmModal div.modal-header h3').html('<?php echo Yii::t("Musiccharts", "Delete musiccharts Confirm Window") ?>');
            jQuery('#myConfirmModal div.modal-body p').html('<?php echo Yii::t("Musiccharts", "Are you sure to delete musiccharts") ?>' + ' ' + name + '?');
