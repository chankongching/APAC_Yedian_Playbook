...
$this->breadcrumbs=array(
	Yii::t('site', 'Musiccharts'),
);
$this->pageTitle = Yii::t('site', Yii::app()->name) . ' - ' . Yii::t('site', 'Musiccharts');
$total = $dataProvider->getTotalItemCount();

$this->menu=array(
	array('label'=>'Create Musiccharts', 'url'=>array('create')),
	array('label'=>'Manage Musiccharts', 'url'=>array('admin')),
);
?>
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-picture"></i> <?php echo Yii::t('site', 'Musiccharts') ?> ( <?php echo $total; ?> <?php echo ($total > 1) ? Yii::t('site', 'musiccharts') : Yii::t('Musiccharts', 'musiccharts'); ?> )</h2>
            <div class="box-icon">
