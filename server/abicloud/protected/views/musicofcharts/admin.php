...
$this->breadcrumbs=array(
	Yii::t('Musicofcharts', 'Musicofcharts'),
);
$this->pageTitle = Yii::t('site', Yii::app()->name) . ' - ' . Yii::t('Musicofcharts', 'Musicofcharts');
$total = $model->count();

$this->menu=array(
	array('label'=>'List Musicofcharts', 'url'=>array('index')),
	array('label'=>'Create Musicofcharts', 'url'=>array('create')),
);
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-picture"></i> <?php echo Yii::t('Musicofcharts', 'Musicofcharts') ?> ( <?php echo $total; ?> <?php echo ($total > 1) ? Yii::t('Musicofcharts', 'musicofcharts') : Yii::t('Musicofcharts', 'musicofcharts'); ?> )</h2>
            <div class="box-icon">
                <!-- a href="#" class="btn btn-setting btn-round"><i class="icon-cog"></i></a -->
                <a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
                <!-- a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a -->
            </div>
            <!-- div style="float:right;"><a href="#" class="btn search-button"><?php echo Yii::t('Musicofcharts', 'Advanced Search') ?></a></div -->
        </div>
        <div class="box-content">
            <div class="btn-toolbar" style="margin-bottom: 15px;margin-top: 0px;border-bottom: 1px solid #EEEEEE;">
                <?php if( Yii::app()->user->checkAccess('Musicofcharts.*') || Yii::app()->user->checkAccess('Musicofcharts.create') ) { ?>
                <div class="btn-group">
                    <a class="btn btn-success btn-round btn-add-file" href="<?php echo $this->createUrl('import'); ?>">
                        ...
                        <?php echo Yii::t('Musicofcharts', 'Import Musicofcharts') ?>                                            
                    </a>
                </div>
                <div class="btn-group">
                    <?php $this->renderExportGridButton('musicofcharts-grid', '导出热歌榜', 'btn-export-csv-file', array('class' => 'btn btn-info btn-round')); ?>
                </div>
                <?php } ?>
            </div><!-- Toolbar -->
	...
	//'update_user_id',
                    ...
                    array(
                        ...
                        'buttons' => array(
                            ...
                            'view' => array(
                                'label' => '',
                                'options' => array('class' => 'icon icon-color icon-search view', 'title' => Yii::t('Musicofcharts', 'View this musicofcharts'))
                            ),
                            'update' => array(
                                'label' => '',
                                'options' => array('class' => 'icon icon-color icon-edit update', 'title' => Yii::t('Musicofcharts', 'Update this musicofcharts'))
                            ),
                            'delete' => array(
                                'label' => '',
                                'options' => array('class' => 'icon icon-color icon-close delete', 'title' => Yii::t('Musicofcharts', 'Delete this musicofcharts'))
                            ),
                        ),
...
<div class="modal hide fade" id="myConfirmAllModal" dialogtype="confirm">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('Musicofcharts', 'Are you sure to delete all musicofcharts?') ?></p>
    </div>
    <div class="modal-footer">
...
<div class="modal hide fade" id="myConfirmModal" dialogtype="confirm">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('Musicofcharts', 'Are you sure to delete this musicofcharts?') ?></p>
    </div>
    <div class="modal-footer">
...
<script type="text/javascript">
    ...
    jQuery(function($) {
        ...
        jQuery('#mySearchFormModal form').submit(function(){
            jQuery('#musicofcharts-grid').yiiGridView('update', {
                data: $(this).serialize()
            });
            return false;
        });
        ...
        jQuery('.btn-delete-allfile').click(function(e) {
            ...
            jQuery('#myConfirmAllModal div.modal-header h3').html('<?php echo Yii::t("Musicofcharts", "Delete All musicofcharts Confirm Window") ?>');
            jQuery('#myConfirmAllModal div.modal-body p').html('<?php echo Yii::t("Musicofcharts", "Are you sure to delete all musicofcharts?") ?>');
        ...
        jQuery('.button-column a.delete').click(function(e) {
            ...
            jQuery('#myConfirmModal div.modal-header h3').html('<?php echo Yii::t("Musicofcharts", "Delete musicofcharts Confirm Window") ?>');
            jQuery('#myConfirmModal div.modal-body p').html('<?php echo Yii::t("Musicofcharts", "Are you sure to delete musicofcharts") ?>' + ' ' + name + '?');
