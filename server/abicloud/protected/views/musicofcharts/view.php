...
$this->pageTitle = Yii::t('site', Yii::app()->name) . ' - ' . Yii::t('Musicofcharts', 'Musicofcharts')  . ' - ' . $model->id;

$this->menu=array(
	array('label'=>'List Musicofcharts', 'url'=>array('index')),
	array('label'=>'Create Musicofcharts', 'url'=>array('create')),
	array('label'=>'Update Musicofcharts', 'url'=>array('update', 'id'=>$model->id)),
	array('label'=>'Delete Musicofcharts', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-film"></i> <?php echo Yii::t('Musicofcharts', 'Musicofcharts') ?> ( <?php echo $model->id; ?> )
            </h2>
            <div class="box-icon">
...
<div class="modal hide fade" id="myConfirmModal">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('Musicofcharts', 'Are you sure to delete musicofcharts {name}?', array('{name}' => $model->id)) ?></p>
    </div>
