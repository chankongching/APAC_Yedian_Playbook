...
$this->breadcrumbs=array(
	Yii::t('site', 'Musicofcharts'),
);
$this->pageTitle = Yii::t('site', Yii::app()->name) . ' - ' . Yii::t('site', 'Musicofcharts');
$total = $dataProvider->getTotalItemCount();

$this->menu=array(
	array('label'=>'Create Musicofcharts', 'url'=>array('create')),
	array('label'=>'Manage Musicofcharts', 'url'=>array('admin')),
);
?>
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-picture"></i> <?php echo Yii::t('site', 'Musicofcharts') ?> ( <?php echo $total; ?> <?php echo ($total > 1) ? Yii::t('site', 'musicofcharts') : Yii::t('Musicofcharts', 'musicofcharts'); ?> )</h2>
            <div class="box-icon">
            ...
            <div class="btn-toolbar" style="margin-bottom: 15px;margin-top: 0px;border-bottom: 1px solid #EEEEEE;">
                <div class="btn-group">
                    <a class="btn btn-success btn-round btn-add-file" href="<?php echo $this->createUrl('create'); ?>">
                        ...
                        <?php echo Yii::t('Musicofcharts', 'Add Musicofcharts') ?>                                            
                    </a>
                </div>
            </div><!-- Toolbar -->
