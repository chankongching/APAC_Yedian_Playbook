...
$this->pageTitle = Yii::t('site', Yii::app()->name) . ' - ' . Yii::t('site', 'QR codes')  . ' - ' . $model->name;

$this->menu=array(
	array('label'=>'List QR code', 'url'=>array('index')),
	array('label'=>'Create QR code', 'url'=>array('create')),
	array('label'=>'Update QR code', 'url'=>array('update', 'id'=>$model->id)),
	array('label'=>'Delete QR code', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-film"></i> <?php echo Yii::t('Qrcode', 'QR code') ?> ( <?php echo $model->name; ?> )
            </h2>
            <div class="box-icon">
