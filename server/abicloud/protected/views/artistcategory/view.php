...
$this->pageTitle = Yii::t('site', Yii::app()->name) . ' - ' . Yii::t('Artistcategory', 'Artistcategories')  . ' - ' . $model->name;

$this->menu=array(
	array('label'=>'List Artistcategory', 'url'=>array('index')),
	array('label'=>'Create Artistcategory', 'url'=>array('create')),
	array('label'=>'Update Artistcategory', 'url'=>array('update', 'id'=>$model->id)),
	array('label'=>'Delete Artistcategory', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-film"></i> <?php echo Yii::t('Artistcategory', 'Artistcategories') ?> ( <?php echo $model->name; ?> )
            </h2>
            <div class="box-icon">
...
<div class="modal hide fade" id="myConfirmModal">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('Artistcategory', 'Are you sure to delete artistcategory {name}?', array('{name}' => $model->name)) ?></p>
    </div>
