...
$this->breadcrumbs=array(
	'Artistofcategories'=>array('index'),
	$model->id=>array('view','id'=>$model->id),
	Yii::t('site', 'Update'),
);
$this->pageTitle = Yii::t('site', Yii::app()->name) . ' - ' . Yii::t('site', 'Artistofcategories')  . ' - ' . $model->id;

$this->menu=array(
	array('label'=>'List Artistofcategory', 'url'=>array('index')),
	array('label'=>'Create Artistofcategory', 'url'=>array('create')),
	array('label'=>'View Artistofcategory', 'url'=>array('view', 'id'=>$model->id)),
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-folder-open"></i> <?php echo Yii::t('Artistofcategory', 'Update Artistofcategory') ?> ( <?php echo $model->id; ?> )
            </h2>
            <div class="box-icon">
