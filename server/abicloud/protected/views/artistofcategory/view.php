...
$this->breadcrumbs=array(
	Yii::t('Artistofcategory', 'Artistofcategories')=>array('index'),
	$model->id,
);
$this->pageTitle = Yii::t('site', Yii::app()->name) . ' - ' . Yii::t('Artistofcategory', 'Artistofcategories')  . ' - ' . $model->id;

$this->menu=array(
	array('label'=>'List Artistofcategory', 'url'=>array('index')),
	array('label'=>'Create Artistofcategory', 'url'=>array('create')),
	array('label'=>'Update Artistofcategory', 'url'=>array('update', 'id'=>$model->id)),
	array('label'=>'Delete Artistofcategory', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-film"></i> <?php echo Yii::t('Artistofcategory', 'Artistofcategories') ?> ( <?php echo $model->id; ?> )
            </h2>
            <div class="box-icon">
...
<div class="modal hide fade" id="myConfirmModal">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('Artistofcategory', 'Are you sure to delete artistofcategory {name}?', array('{name}' => $model->id)) ?></p>
    </div>
