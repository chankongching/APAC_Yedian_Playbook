...
<fieldset>
    <legend>
        ...
        <label>无需标题行，首行为空行。每行一条记录，以回车换行，每行记录格式如下：</label>
        <p>歌手ID,歌手姓名,分类ID</p>
        <label>示例：</label>
        <label>1,刘德华,10</label>
        <label>2,王菲,10</label>
        <label>.</label>
        <label>.</label>
        <label>.</label>
        <label>&nbsp;</label>
        <label>注意：歌手图片文件名最好为英文名，歌手图片文件统一复制到AbiKTV系统的 uploads/attach/artist 目录下。</label>
    </legend>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                    <input class="input-file uniform_on" id="ytFiles_bpic_file" name="Artistofcategory[bpic_file]" type="file">
