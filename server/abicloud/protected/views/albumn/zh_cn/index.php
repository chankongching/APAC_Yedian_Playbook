...
$this->pageTitle = Yii::t('site', Yii::app()->name) . ' - ' . Yii::t('site', 'Albumns');
$total = $dataProvider->getTotalItemCount();

$this->menu=array(
	array('label'=>'Create Albumn', 'url'=>array('create')),
	array('label'=>'Manage Albumn', 'url'=>array('admin')),
);
?>
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-picture"></i> <?php echo Yii::t('site', 'Albumns') ?> ( <?php echo $total; ?> <?php if($total > 1) echo Yii::t('site', 'albumns'); else echo Yii::t('Albumn', 'albumn'); ?> )</h2>
            <div class="box-icon">
            ...
            <div class="btn-toolbar" style="margin-bottom: 15px;margin-top: 0px;border-bottom: 1px solid #EEEEEE;">
                <div class="btn-group">
                    <a class="btn btn-success btn-round btn-add-file" href="<?php echo $this->createUrl('create'); ?>">
                        ...
                        <?php echo Yii::t('Albumn', 'Add Albumn') ?>                                            
                    </a>
                </div>
            </div><!-- Toolbar -->
	...
	//'name_pinyin',
                    ...
                    array(
                        ...
                        'buttons' => array(
                            ...
                            'view' => array(
                                'label' => '',
                                'options' => array('class' => 'icon icon-color icon-search view', 'title' => Yii::t('Albumn', 'View this albumn'))
                            ),
                            'update' => array(
                                'label' => '',
                                'options' => array('class' => 'icon icon-color icon-edit update', 'title' => Yii::t('Albumn', 'Update this albumn'))
                            ),
                            'delete' => array(
                                'label' => '',
                                'options' => array('class' => 'icon icon-color icon-close delete', 'title' => Yii::t('Albumn', 'Delete this albumn'))
                            ),
                        ),
...
<div class="modal hide fade" id="myConfirmAllModal">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('Albumn', 'Are you sure to delete all albumns?') ?></p>
    </div>
...
<div class="modal hide fade" id="myConfirmModal">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('Albumn', 'Are you sure to delete this albumn?') ?></p>
    </div>
    <div class="modal-footer">
...
<script type="text/javascript">
    ...
    jQuery(function($) {
        jQuery('.btn-delete-allfile').click(function(e) {
            e.preventDefault();
            jQuery('#myConfirmAllModal div.modal-body p').html('<?php echo Yii::t("Albumn", "Are you sure to delete all albumns?") ?>');
        ...
        jQuery('.button-column a.delete').click(function(e) {
            ...
            jQuery('#myConfirmModal div.modal-body p').html('<?php echo Yii::t("Albumn", "Are you sure to delete albumn") ?>' + ' ' + name + '?');
