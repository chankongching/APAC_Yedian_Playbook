...
<fieldset>
    ...
    <div class="control-group">
	<?php echo $form->labelEx($model,'call_id', array('class' => 'control-label')); ?>
        <div class="controls">
    ...
    <div class="control-group">
	<?php echo $form->labelEx($model,'call_ip', array('class' => 'control-label')); ?>
        <div class="controls">
		<?php echo $form->textField($model,'call_ip',array('size'=>60,'maxlength'=>64)); ?>
		<?php echo $form->error($model,'call_ip'); ?>
        </div>
    </div>
