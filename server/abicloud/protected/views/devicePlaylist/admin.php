...
$this->menu=array(
	array('label'=>'List DevicePlaylist', 'url'=>array('index')),
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-picture"></i> <?php echo Yii::t('site', 'Device Playlists') ?> ( <?php echo $total; ?> <?php echo ($total > 1) ? Yii::t('site', 'device playlists') : Yii::t('DevicePlaylist', 'deviceplaylist'); ?> )</h2>
            <div class="box-icon">
                <a href="#" class="btn btn-setting btn-round"><i class="icon-cog"></i></a>
                <a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
                <!-- a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a -->
            </div>
            <div style="float:right;"><a href="#" class="btn search-button"><?php echo Yii::t('DevicePlaylist', 'Advanced Search') ?></a></div>
        </div>
...
<script type="text/javascript">
    ...
    jQuery(function($) {
        ...
        jQuery('#mySearchFormModal form').submit(function(){
            jQuery('#deviceplaylist-grid').yiiGridView('update', {
                data: $(this).serialize()
            });
            return false;
        });
        ...
        jQuery('.btn-delete-allfile').click(function(e) {
            ...
            jQuery('#myConfirmAllModal div.modal-header h3').html('<?php echo Yii::t("DevicePlaylist", "Delete All device playlists Confirm Window") ?>');
        ...
        jQuery('.button-column a.delete').click(function(e) {
            ...
            jQuery('#myConfirmModal div.modal-header h3').html('<?php echo Yii::t("DevicePlaylist", "Delete deviceplaylist Confirm Window") ?>');
