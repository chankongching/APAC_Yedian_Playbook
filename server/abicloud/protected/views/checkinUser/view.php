...
$this->breadcrumbs=array(
	Yii::t('site', 'Checkin Users')=>array('index'),
	$model->id,
);
...
$this->menu=array(
	...
	array('label'=>'Update CheckinUser', 'url'=>array('update', 'id'=>$model->id)),
	array('label'=>'Delete CheckinUser', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-film"></i> <?php echo Yii::t('CheckinUser', 'CheckinUser') ?> ( <?php echo $model->id; ?> )
            </h2>
            <div class="box-icon">
...
<div class="modal hide fade" id="myConfirmModal">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('CheckinUser', 'Are you sure to delete checkinuser {name}?', array('{name}' => $model->id)) ?></p>
    </div>
