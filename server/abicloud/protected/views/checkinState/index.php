...
$this->breadcrumbs=array(
	Yii::t('site', 'Checkin States'),
);
$this->pageTitle = Yii::t('site', Yii::app()->name) . ' - ' . Yii::t('site', 'Checkin States');
$total = $dataProvider->getTotalItemCount();

$this->menu=array(
	array('label'=>'Create CheckinState', 'url'=>array('create')),
	array('label'=>'Manage CheckinState', 'url'=>array('admin')),
);
?>
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-picture"></i> <?php echo Yii::t('site', 'Checkin States') ?> ( <?php echo $total; ?> <?php if($total > 1) echo Yii::t('site', 'checkin states'); else echo Yii::t('CheckinState', 'checkinstate'); ?> )</h2>
            <div class="box-icon">
        ...
        <div class="box-content">
            <div class="btn-toolbar" style="margin-bottom: 15px;margin-top: 0px;border-bottom: 1px solid #EEEEEE;">
                <div class="btn-group">
                    <a class="btn btn-success btn-round btn-add-file" href="<?php echo $this->createUrl('create'); ?>">
                        ...
                        <?php echo Yii::t('CheckinState', 'Add CheckinState') ?>                                            
                    </a>
                </div>
            </div><!-- Toolbar -->
            ...
            <?php endif; ?>
            <!-- Begin CheckinState list -->

            <?php
            $this->widget('zii.widgets.grid.CGridView', array(
                'id' => 'checkinstate-grid',
	...
	'update_user_id',
                    ...
                    array(
                        ...
                        'buttons' => array(
                            ...
                            'view' => array(
                                'label' => '',
                                'options' => array('class' => 'icon icon-color icon-search view', 'title' => Yii::t('CheckinState', 'View this checkinstate'))
                            ),
                            'update' => array(
                                'label' => '',
                                'options' => array('class' => 'icon icon-color icon-edit update', 'title' => Yii::t('CheckinState', 'Update this checkinstate'))
                            ),
                            'delete' => array(
                                'label' => '',
                                'options' => array('class' => 'icon icon-color icon-close delete', 'title' => Yii::t('CheckinState', 'Delete this checkinstate'))
                            ),
                        ),
...
<div class="modal hide fade" id="myConfirmAllModal">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('CheckinState', 'Are you sure to delete all checkin states?') ?></p>
    </div>
...
<div class="modal hide fade" id="myConfirmModal">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('CheckinState', 'Are you sure to delete this checkinstate?') ?></p>
    </div>
    <div class="modal-footer">
...
<script type="text/javascript">
    ...
    jQuery(function($) {
        jQuery('.btn-delete-allfile').click(function(e) {
            e.preventDefault();
            jQuery('#myConfirmAllModal div.modal-body p').html('<?php echo Yii::t("CheckinState", "Are you sure to delete all checkin states?") ?>');
        ...
        jQuery('.button-column a.delete').click(function(e) {
            ...
            jQuery('#myConfirmModal div.modal-body p').html('<?php echo Yii::t("CheckinState", "Are you sure to delete checkinstate") ?>' + ' ' + name + '?');
