...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-picture"></i> <?php echo Yii::t('site', 'Users') ?> ( <?php echo $total; ?> <?php if($total > 1) echo Yii::t('site', 'users'); else echo Yii::t('User', 'user'); ?> )</h2>
            <div class="box-icon">
	...
	//'update_user_id',
                    ...
                    array(
                        ...
                        'buttons' => array(
                            ...
                            'view' => array(
                                'label' => '',
                                'options' => array('class' => 'icon icon-color icon-search view', 'title' => Yii::t('User', 'View this user'))
                            ),
                            'update' => array(
                                'label' => '',
                                'options' => array('class' => 'icon icon-color icon-edit update', 'title' => Yii::t('User', 'Update this user'))
                            ),
                            'delete' => array(
                                'label' => '',
                                'options' => array('class' => 'icon icon-color icon-close delete', 'title' => Yii::t('User', 'Delete this user'))
                            ),
                        ),
...
<div class="modal hide fade" id="myConfirmAllModal">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('User', 'Are you sure to delete all users?') ?></p>
    </div>
...
<div class="modal hide fade" id="myConfirmModal">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('User', 'Are you sure to delete this user?') ?></p>
    </div>
    <div class="modal-footer">
...
<script type="text/javascript">
    ...
    jQuery(function($) {
        jQuery('.btn-delete-allfile').click(function(e) {
            e.preventDefault();
            jQuery('#myConfirmAllModal div.modal-body p').html('<?php echo Yii::t("User", "Are you sure to delete all users?") ?>');
        ...
        jQuery('.button-column a.delete').click(function(e) {
            ...
            jQuery('#myConfirmModal div.modal-body p').html('<?php echo Yii::t("User", "Are you sure to delete user") ?>' + ' ' + name + '?');
