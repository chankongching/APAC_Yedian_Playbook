...
$this->breadcrumbs=array(
	Yii::t('site', 'Yii Sessions')=>array('index'),
	$model->id,
);
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-film"></i> <?php echo Yii::t('YiiSession', 'YiiSession') ?> ( <?php echo $model->id; ?> )
            </h2>
            <div class="box-icon">
...
<div class="modal hide fade" id="myConfirmModal">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('YiiSession', 'Are you sure to delete yiisession {name}?', array('{name}' => $model->id)) ?></p>
    </div>
