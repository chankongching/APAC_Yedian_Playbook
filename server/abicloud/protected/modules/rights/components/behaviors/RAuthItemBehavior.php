...
class RAuthItemBehavior extends CBehavior
{
	...
	*/
	...
	{
		return CHtml::linkButton('<i class="icon icon-color icon-remove"></i>' . Rights::t('core', 'Delete'), array(
	...
	*/
	...
	{
		return CHtml::linkButton('<i class="icon icon-color icon-remove"></i>' . Rights::t('core', 'Remove'), array(
	...
	*/
	...
	{
            if( $this->owner->name!==Rights::module()->superuserName || $this->userId != 1){
		return CHtml::linkButton('<i class="icon icon-color icon-remove"></i>' . Rights::t('core', 'Revoke'), array(
	...
	*/
	public function getRevokePermissionLink(CAuthItem $role)
	{
		...
		return CHtml::link('<i class="icon icon-color icon-remove"></i>' . Rights::t('core', 'Revoke'), '#', array(
			'onclick'=>"
				jQuery.ajax({
					type:'POST',
	...
	*/
	public function getAssignPermissionLink(CAuthItem $role)
	{
		...
		return CHtml::link('<i class="icon icon-color icon-add"></i>' . Rights::t('core', 'Assign'), '#', array(
			'onclick'=>"
				jQuery.ajax({
					type:'POST',
