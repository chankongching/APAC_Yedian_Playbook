 ...
 */
class SmsVerify extends PSActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('userid, create_user_id, update_user_id', 'numerical', 'integerOnly'=>true),
			array('mobile, code,', 'length', 'max'=>255),
			array('create_time, update_time', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('mobile, code, userid, create_time, create_user_id, update_time, update_user_id', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'mobile' => Yii::t('Category','Mobile'),
			'code' => Yii::t('Category','Code'),
			'userid' => Yii::t('Category','User ID'),
