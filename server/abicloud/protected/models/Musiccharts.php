...
/**
 * This is the model class for table "{{musiccharts}}".
 *
 * The followings are the available columns in table '{{musiccharts}}':
 * @property integer $id
 ...
 * @property Musicofcharts[] $musicofcharts
 */
class Musiccharts extends PSActiveRecord
{
    public $bpic_file;
    public $spic_file;
    public $attach_path = '';
	...
	public function relations()
	{
		...
		return array(
			'musicofcharts' => array(self::HAS_MANY, 'Musicofcharts', 'chart_id'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'name' => Yii::t('Musiccharts', 'Name'),
			'description' => Yii::t('Musiccharts', 'Description'),
			'bpic_filename' => Yii::t('Musiccharts', 'Bpic Filename'),
			'bpic_url' => Yii::t('Musiccharts', 'Bpic Url'),
			'spic_filename' => Yii::t('Musiccharts', 'Spic Filename'),
			'spic_url' => Yii::t('Musiccharts', 'Spic Url'),
			...
			'update_user_id' => Yii::t('site', 'Update User'),
                        'bpic_file' => Yii::t('Musiccharts', 'Select File'),
                        'spic_file' => Yii::t('Musiccharts', 'Select File'),
		);
	}
	 ...
	 * @return Musiccharts the static model class
	 */
