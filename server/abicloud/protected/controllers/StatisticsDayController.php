...
class StatisticsDayController extends Controller
{
	/**
...
//	}
        ...
        public function behaviors() {
            return array(
                'exportableGrid' => array(
                    ...
                    'filename' => 'StatisticsDay-' . date('YmdHis', time()) . '.csv',
            ));
        }
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['StatisticsDay']))
		{
			$model->attributes=$_POST['StatisticsDay'];
			if($model->save())
	...
	public function actionIndex()
	{
		...
		//));
		$model=new StatisticsDay('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['StatisticsDay']))
			$model->attributes=$_GET['StatisticsDay'];
	...
	{
		$model=StatisticsDay::model()->findByPk($id);
		if($model===null)
