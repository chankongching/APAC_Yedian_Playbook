...
//        $feedback->openid    = isset($post_array['openid']) ? $post_array['openid'] : '';
	...
	public function actionComment() {
		...
		$comment->openid = isset($post_array['openid']) ? $post_array['openid'] : '';
		...
		if ($comment->ktvid === '' || $comment->openid === '' || $comment->DecorationRating === '' || $comment->SoundRating === '' || $comment->ServiceRating === '' || $comment->ConsumerRating === '' || $comment->FoodRating === '' || $comment->appRating === '') {
			$this->sendResults($result_array, self::BadRequest);
		}
		$comment->save();
		$result_array['result'] = self::Success;
