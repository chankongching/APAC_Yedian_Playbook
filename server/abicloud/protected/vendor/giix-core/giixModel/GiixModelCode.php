...
Yii::import('application.vendor.giix-core.helpers.*');
...
class GiixModelCode extends ModelCode {
    ...
    public function prepare() {
        ...
        foreach ($tables as $table) {
            ...
            $this->files[] = new CCodeFile(
                    Yii::getPathOfAlias($this->baseModelPath . '.' . $this->baseModelClass) . '.php', $this->render($templatePath . DIRECTORY_SEPARATOR . '_base' . DIRECTORY_SEPARATOR . 'basemodel.php', $params)
            );
        }
    }
