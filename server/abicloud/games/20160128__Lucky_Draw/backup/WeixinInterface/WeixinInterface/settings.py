...
MY_SERVER_DOMAIN = 'http://wx.carpenter-cn.com/'
#MY_SERVER_DOMAIN = 'http://wx.anertuo.com/'
ALLOWED_HOSTS = ['wx.carpenter-cn.com', 'wx.yxwechat.com',]
...
STATIC_ROOT = '/pywww/static/'
STATIC_URL = 'http://wx.carpenter-cn.com/static/'
#STATIC_URL = '/static/'
STATICFILES_DIRS = (
