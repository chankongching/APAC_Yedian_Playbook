...
<html>
    <head>
        <meta charset="utf-8">
        <title><?php echo Yii::app()->name; ?> Download</title>
    ...
    <body>
        <div class="container-fluid" style="text-align:center;">
            ...
            <?php } else { ?>
            <a href="<?php echo Yii::app()->createAbsoluteUrl('//') . '/uploads/AbiKtv.apk'; ?>"><img style="width:98%;" src="<?php echo Yii::app()->createAbsoluteUrl('//') . '/uploads/download.png'; ?>"></a>
            <?php } ?>
        </div>
    </body>
</html>
