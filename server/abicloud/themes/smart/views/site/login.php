    ...
    <div class="well span5 center login-box">
        <div class="alert alert-info">
            ...
            if (empty($error_info)) {
                ...
                echo '<span style="color:#BC628B">' . $error_info . '</span>';
            }
            ?>
        </div>
        <form class="form-horizontal" id="login-form" action="<?php echo $this->createUrl('site/login'); ?>" method="post">
            <fieldset>
                ...
                <div class="input-prepend">
                    <label class="remember" for="remember"><input type="checkbox" name="LoginForm[rememberMe]" id="LoginForm_rememberMe" value="1" />Remember me</label>
                </div>
                <div class="clearfix"></div>

                <p class="center span5">
                    <button type="submit" name="yt0" class="btn btn-primary">Login</button>
                </p>
            </fieldset>
        </form>
    </div><!--/span-->
