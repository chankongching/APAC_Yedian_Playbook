...
<fieldset>
    <legend><?php echo Yii::t('Application', 'Fields with {required} are required to {operate} application.', array('{required}' => '<span class="required">*</span>', '{operate}' => Yii::t('site', ($model->isNewRecord ? 'create' : 'update')))) ?></legend>
