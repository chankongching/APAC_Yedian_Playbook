                    ...
                    <div class="span2 main-menu-span">
                        <div class="well nav-collapse sidebar-nav">
                            <ul class="nav nav-tabs nav-stacked main-menu">
                                ...
                                <li><a class="ajax-link" href="<?php echo $this->createUrl('adminUser/index'); ?>" title="<?php echo Yii::t('site', 'User Admin') ?>"><i class="icon-user"></i><span class="hidden-tablet"> <?php echo Yii::t('site', 'User Admin') ?></span>
                                        <?php echo '<span class="mynotification yellow hidden-tablet" style="">' . User::model()->count() . '</span>'; ?>
                                    </a></li>
                                <?php } ?>
                                <?php if( Yii::app()->user->checkAccess('ActivityQrcode.*') || Yii::app()->user->checkAccess('ActivityQrcode.Index') ) { ?>
                                <li><a href="<?php echo $this->createUrl('activityQrcode/index'); ?>" title="<?php echo Yii::t('site', 'QR Code') ?>"><i class="icon-globe"></i><span class="hidden-tablet"> <?php echo Yii::t('site', 'QR Code') ?></span>
                                        <?php echo '<span class="mynotification yellow hidden-tablet" style="">' . ActivityQrcode::model()->count() . '</span>'; ?>
                                    </a></li>
                                <?php } ?>
                            </ul>
                        </div><!--/.well -->
