...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-user"></i> User ( <?php echo $model->username; ?> )
            </h2>
            <div class="box-icon">
        ...
        <div class="box-content">
            <div class="btn-toolbar" style="margin-bottom: 15px;margin-top: 0px;border-bottom: 1px solid #EEEEEE;">
                <div class="btn-group">
                    <a class="btn btn-success btn-round btn-update-user" href="<?php echo $this->createUrl('user/update',array('id'=>$model->id)); ?>">
            ...
            <div>
                ...
                $this->widget('zii.widgets.CDetailView', array(
                    ...
                    'attributes' => array(
                        ...
                        'update_time',
                        'update_user_id' => array('name' => 'Update User', 'value' => $update_user_name),
                    ),
