...
$this->pageTitle = Yii::t('site', Yii::app()->name) . ' - ' . Yii::t('site', 'Vendors');
...
@media (max-width: 480px) {
	...
	.grid-view table th:nth-child(6) {display:none;}
}
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-picture"></i> <?php echo Yii::t('site', 'Vendors') ?> ( <?php echo $total; ?> <?php if($total > 1) echo Yii::t('site', 'vendors'); else echo Yii::t('Vendor', 'vendor'); ?> )</h2>
            <div class="box-icon">
            ...
            <div class="btn-toolbar" style="margin-bottom: 15px;margin-top: 0px;border-bottom: 1px solid #EEEEEE;">
                <div class="btn-group">
                    <a class="btn btn-success btn-round btn-add-file" href="<?php echo $this->createUrl('create'); ?>">
                        ...
                        <?php echo Yii::t('Vendor', 'Add Vendor') ?>                                            
                    </a>
                </div>
            </div><!-- Toolbar -->
	...
	'update_user_id',
                    ...
                    array(
                        ...
                        'buttons' => array(
                            ...
                            'view' => array(
                                'label' => '',
                                'options' => array('class' => 'icon icon-color icon-search view', 'title' => Yii::t('Vendor', 'View this vendor'))
                            ),
                            'update' => array(
                                'label' => '',
                                'options' => array('class' => 'icon icon-color icon-edit update', 'title' => Yii::t('Vendor', 'Update this vendor'))
                            ),
                            'delete' => array(
                                'label' => '',
                                'options' => array('class' => 'icon icon-color icon-close delete', 'title' => Yii::t('Vendor', 'Delete this vendor'))
                            ),
                        ),
...
<div class="modal hide fade" id="myConfirmAllModal">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('Vendor', 'Are you sure to delete all vendors?') ?></p>
    </div>
...
<div class="modal hide fade" id="myConfirmModal">
    ...
    <div class="modal-body">
        <p><?php echo Yii::t('Vendor', 'Are you sure to delete this vendor?') ?></p>
    </div>
    <div class="modal-footer">
...
<script type="text/javascript">
    ...
    jQuery(function($) {
        jQuery('.btn-delete-allfile').click(function(e) {
            e.preventDefault();
            jQuery('#myConfirmAllModal div.modal-body p').html('<?php echo Yii::t("Vendor", "Are you sure to delete all vendors?") ?>');
        ...
        jQuery('.button-column a.delete').click(function(e) {
            ...
            jQuery('#myConfirmModal div.modal-body p').html('<?php echo Yii::t("Vendor", "Are you sure to delete vendor") ?>' + ' ' + name + '?');
