...
$m = (isset($_GET['m']) && in_array(trim($_GET['m']), array('getQR', 'getAchievement'))) ? trim($_GET['m']) : die();
...
switch($m) {
    ...
    case 'getQR':
        ...
        // 
        $url = 'http://letsktv.chinacloudapp.cn/letsktv_biz/_wechat/index.php?m=getToken';
        $ch = curl_init();
