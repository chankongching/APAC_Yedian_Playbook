...
$_SESSION['letsktv_biz_promogirls_openid'] = $rs['openid'];

if(isset($_SESSION['letsktv_biz_promogirls_http_referer']) && !empty($_SESSION['letsktv_biz_promogirls_http_referer'])) {
    $url = sprintf('%s', 
        $_SESSION['letsktv_biz_promogirls_http_referer']
    );
    $_SESSION['letsktv_biz_promogirls_http_referer'] == null;
    unset($_SESSION['letsktv_biz_promogirls_http_referer']);
} else {
    $url = sprintf('%s', 
        URL
    );
