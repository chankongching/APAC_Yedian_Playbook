...
<head>
    ...
    <title>入场时间管理-套餐系统-夜点管理系统</title>
    <!-- =============== VENDOR STYLES ===============-->
    <!-- FONT AWESOME-->
            ...
            <div class="content-wrapper">
                <div class="content-heading">
                    <a href="<?php echo U('Xktv/update');?>"><button type="button" class="btn btn-primary pull-right" id="importdata">
                        <em class="fa fa-plus-circle fa-fw mr-sm"></em>添加入场时间</button></a>入场时间管理</div>
                <div class="table-responsive b0">
                    <table id="enterTime" class="table table-striped table-hover">
                        <thead>
                            <tr>
                                <th>
                                    <strong>ID</strong>
