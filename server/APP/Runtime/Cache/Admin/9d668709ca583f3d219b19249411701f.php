    ...
    <section>
        ...
        <div class="content-wrapper">
            <div class="content-heading">
                <a href="<?php echo U('Taocan/addshijianduan');?>">
            ...
            <div class="table-responsive b0">
                <table id="datelists1" class="table table-striped table-hover">
                    <thead>
                    <tr>
                        <th>
                            <strong>ID</strong>
                    ...
                    <tbody>
                    <?php if(is_array($datalists)): $i = 0; $__LIST__ = $datalists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr role="row" class="odd">
                            <td class="sorting"><?php echo ($vo["id"]); ?></td>
                            <td><?php echo ($vo["name"]); ?></td>
                            <td><a href="<?php echo U('updateshijianduan',array('id'=>$vo['id']));?>">修改</a></td>
