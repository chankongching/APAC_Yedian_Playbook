    ...
    <div class="aside-inner">
        <nav data-sidebar-anyclick-close="" class="sidebar">
            ...
            <ul class="nav">
                ...
                <li class=" ">
                    <a href="#taocan" title="套餐管理" data-toggle="collapse">
                        <!-- <div class="pull-right label label-info">0</div> -->
                        <em class="icon-wrench"></em>
                        <span data-localize="sidebar.nav.MXktv">套餐管理</span>
                    </a>
                    <ul id="taocan" class="nav sidebar-subnav collapse">
                        <li class="sidebar-subnav-header">套餐管理</li>
                        <li class=" ">
                            <a href="<?php echo U('Taocan/datelists');?>" title="时间段添加">
                                <span>时间段添加</span>
                            </a>
                        </li>
                    </ul>
        ...
        <section>
            ...
            <div class="content-wrapper">
                <div class="content-heading">
                    <a href="<?php echo U('Xktv/update');?>">
                        <button type="button" class="btn btn-primary pull-right" id="importdata">
                            <em class="fa fa-plus-circle fa-fw mr-sm"></em>添加房型</button>
                    </a>房型管理</div>
                <div class="table-responsive b0">
                    <table id="roomtype1" class="table table-striped table-hover">
                        <thead>
                            <tr>
                                <th>
                                    <strong>ID</strong>
                        ...
                        <tbody>
                            <tr role="row" class="odd">
                                ...
                                <td>20</td>
                                <td>无</td>
                                <td><a href="/wechatshangjia/Admin/Xktv/update/id/1.html">查看</a><a href="/wechatshangjia/Admin/Xktv/update/id/1.html">删除</a></td>
                            </tr>
