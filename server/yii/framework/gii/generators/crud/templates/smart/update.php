...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-folder-open"></i> <?php echo "<?php"; ?> echo Yii::t('<?php echo $this->modelClass; ?>', 'Update <?php echo $this->modelClass; ?>') ?> ( <?php echo "<?php"; ?> echo $model-><?php echo $nameColumn; ?>; ?> )
            </h2>
            <div class="box-icon">
